...
type graphErr struct {
	...
	// Additional fields returned by Lacinia
	Value         string
...
// GraphResponse contains the data and errors for a GraphQL response. It's
// provided for when the GraphQL API might return custom fields for an error.
